/*
 * Firebase app vendor bundle was removed from the active extension.
 * For cleanliness this file has been replaced with a small stub that
 * points to the archived copy at `archived_firebase/firebase-app.js`.
 *
 * If you need the original bundle again, find it in `archived_firebase/`.
 */

// noop stub to avoid accidental heavy imports
export default {};
